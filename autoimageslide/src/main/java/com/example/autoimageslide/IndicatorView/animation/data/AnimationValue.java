package com.example.autoimageslide.IndicatorView.animation.data;

import androidx.annotation.NonNull;

import com.example.autoimageslide.IndicatorView.animation.data.type.ColorAnimationValue;
import com.example.autoimageslide.IndicatorView.animation.data.type.DropAnimationValue;
import com.example.autoimageslide.IndicatorView.animation.data.type.FillAnimationValue;
import com.example.autoimageslide.IndicatorView.animation.data.type.ScaleAnimationValue;
import com.example.autoimageslide.IndicatorView.animation.data.type.SwapAnimationValue;
import com.example.autoimageslide.IndicatorView.animation.data.type.ThinWormAnimationValue;
import com.example.autoimageslide.IndicatorView.animation.data.type.WormAnimationValue;
