...
public abstract class ContainerActivity extends BaseActivity implements ContainerView {
  ...
  public void pushView(IView view) {
    if (view instanceof BaseFragment) {
      ...
      addFragment(((BaseDialogFragment) view)
                      .setAnimIn(R.anim.slide_right_in)
                      .setAnimOut(R.anim.slide_right_out),
              true);
    }
  ...
  public void pushView(IView view, int frameId) {
    if (view instanceof BaseFragment) {
      addFragment(frameId, (BaseFragment) view, false, null);
    }
  }
  ...
  public void addFragment(BaseDialogFragment fragment, boolean addToBackStack) {
    addFragment(fragment, addToBackStack, fragment.getClass().getSimpleName());
  }
  ...
  public void addFragment(BaseDialogFragment fragment, boolean addToBackStack, String tag) {
    addChildFragment(CoreDefault.FRAGMENT_CONTAINER_ID, fragment, addToBackStack, tag);
  }
