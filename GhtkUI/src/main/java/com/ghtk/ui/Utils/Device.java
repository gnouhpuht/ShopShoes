...
public class Device {
    ...
    public static Device instance(Activity activity) {
    ...
    public boolean checkGrantPermissions(String[] permissions) {
        if (mActivity == null) {
            return false;
        }

        int permissionNumber = permissions.length;
    ...
    public boolean setGrantPermissions(String[] permissions) {
        try {
