    ...
    private void relocation(int[] location) {
        ...
        switch (gravity) {
            ...
            case GRAVITY_LEFT:
                ...
                break;
            case GRAVITY_RIGHT:
                llContent.setX(location[0] + ivTriangle.getWidth());
...
//                llContent.setX(0);
        ...
        switch (gravity) {
            ...
            case GRAVITY_LEFT:
                ...
                break;
            case GRAVITY_RIGHT:
                ivTriangle.setX(location[0]);
                ivTriangle.setY(location[1] - llContent.getHeight() / 2 - statusBarHeight);
                triangleCenterY = (int) (ivTriangle.getY() + ivTriangle.getHeight() / 2);
                contentHeight = llContent.getHeight();
                topMargin = triangleCenterY;
                bottomMargin = getScreenHeight() - topMargin;
                availableTopMargin = topMargin - layoutParams.topMargin;
                availableBottomMargin = bottomMargin - layoutParams.bottomMargin;
                y = 0;
                if (contentHeight / 2 <= availableTopMargin && contentHeight / 2 <= availableBottomMargin) {
                    y = triangleCenterY - contentHeight / 2;
                } else {
