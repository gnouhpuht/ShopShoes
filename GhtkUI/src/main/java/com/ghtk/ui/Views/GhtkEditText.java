...
public class GhtkEditText extends AppCompatEditText {
    ...
    public GhtkEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public GhtkEditText(Context context) {
        super(context);
    }
    public GhtkEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.GhtkEditText, 0, 0);
        try {
            int style = a.getInteger(R.styleable.GhtkEditText_font_text_edittext, 10);
