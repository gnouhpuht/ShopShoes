...
public class GhtkTextView extends AppCompatTextView {
    ...
    public GhtkTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.GhtkTextView, 0, 0);
        try {
            int style = a.getInteger(R.styleable.GhtkTextView_font_text_view, 5);
